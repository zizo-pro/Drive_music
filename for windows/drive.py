...
if author.upper() in current_files:
    move(f"E:\ZIZO\songs_before\{title.upper()}.mp3",f"\ZIZO\songs\{author.upper()}\{title.upper()}.mp3")

else:
    mkdir(f"E:\ZIZO\songs\{author.upper()}")
    move(f"E:\ZIZO\songs_before\{title.upper()}.mp3",f"E:\ZIZO\songs\{author.upper()}\{title.upper()}.mp3")
